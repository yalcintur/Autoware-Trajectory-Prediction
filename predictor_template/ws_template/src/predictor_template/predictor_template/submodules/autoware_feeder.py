...
from ..submodules.layers.graph import Graph

import time


class Feeder(torch.utils.data.Dataset):
	""" Feeder for skeleton-based action recognition for Autoware
	Arguments:
	...
	def load_data(self):
		...
		[self.all_feature, self.all_adjacency, self.all_mean_xy]= pickle.loads(self.data_path)
